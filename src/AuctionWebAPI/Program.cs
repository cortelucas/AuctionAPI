...
using AuctionWebAPI.Repositories.DataAccess;
...
builder.Services.AddDbContext<AuctionWebAPIDbContext>(options =>
{
    options.UseSqlite(@"Data Source=/home/cortelucas/dev/github/rocketseat/AuctionAPI/auction.db");
});
